...
<html>
    <head>
        ...
        <title>Login - Tharros Security Solutions, LLC</title>
    ...
    <body>
        <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        ...
                        <div class="text-2xl text-custom-dark-blue tracking-wide ml-2 font-semibold">Tharros</div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    <div class="mt-12">
                        <form>
                            ...
                            <div class="mt-10">
                                <button class="bg-custom-dark-blue text-gray-100 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-custom-dark-blue shadow-lg" type="submit">
                                    Log In
                                </button>
                            </div>
                        </form>
            ...
            <div class="hidden lg:flex items-center justify-center bg-custom-dark-blue flex-1 h-screen">
